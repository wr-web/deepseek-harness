...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-context-graph': { kind: 'none', reason: 'Browser-side graph projection and fork controls; the Host context-graph package owns automatic model-visible recall.' },
